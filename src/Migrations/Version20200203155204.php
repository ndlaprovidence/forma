 ...
 */
<<<<<<< HEAD:src/Migrations/Version20200130132919.php
final class Version20200130132919 extends AbstractMigration
=======
final class Version20200203155204 extends AbstractMigration
>>>>>>> develop:src/Migrations/Version20200203155204.php
{
...
=======
        $this->addSql('CREATE TABLE tbl_company (id INT AUTO_INCREMENT NOT NULL, corporate_name VARCHAR(255) NOT NULL, siret_number VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, postal_code VARCHAR(255) DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
>>>>>>> develop:src/Migrations/Version20200203155204.php
        ...
        $this->addSql('CREATE TABLE tbl_location (id INT AUTO_INCREMENT NOT NULL, street VARCHAR(255) DEFAULT NULL, postal_code INT NOT NULL, city VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
...
<<<<<<< HEAD:src/Migrations/Version20200130132919.php
        $this->addSql('CREATE TABLE tbl_training (id INT AUTO_INCREMENT NOT NULL, training_category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, platform VARCHAR(255) NOT NULL, INDEX IDX_82216CA2B62DE735 (training_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
=======
        $this->addSql('CREATE TABLE tbl_training (id INT AUTO_INCREMENT NOT NULL, training_category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, platform VARCHAR(255) NOT NULL, reference_number VARCHAR(255) DEFAULT NULL, INDEX IDX_82216CA2B62DE735 (training_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
>>>>>>> develop:src/Migrations/Version20200203155204.php

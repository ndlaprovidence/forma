 ...
 */
final class Version20200121072938 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE tbl_session (id INT AUTO_INCREMENT NOT NULL, training_id INT NOT NULL, location_id INT NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, comment LONGTEXT DEFAULT NULL, INDEX IDX_8B17DDA0BEFD98D1 (training_id), INDEX IDX_8B17DDA064D218E (location_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE session_trainee (id INT AUTO_INCREMENT NOT NULL, sessions_id INT NOT NULL, document_name VARCHAR(255) NOT NULL, INDEX IDX_541E0FBDF17C4D8C (sessions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE session_trainer (id INT AUTO_INCREMENT NOT NULL, sessions_id INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_D7CD8A7AF17C4D8C (sessions_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tbl_trainee (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, session_trainee_id INT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, INDEX IDX_1D958593979B1AD6 (company_id), INDEX IDX_1D958593D650898B (session_trainee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tbl_trainer (id INT AUTO_INCREMENT NOT NULL, session_trainer_id INT NOT NULL, last_name VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, INDEX IDX_9E4600541B9EE6AD (session_trainer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE session_trainee DROP FOREIGN KEY FK_541E0FBDF17C4D8C');
        $this->addSql('ALTER TABLE session_trainer DROP FOREIGN KEY FK_D7CD8A7AF17C4D8C');
